# -*- coding: utf-8 -*-
"""
Created on Mon Dec 25 17:54:25 2023
...
attendance = pd.DataFrame(columns=['Name', 'Date', 'Attendance'])
...
while True:
    ...
    for current_face_location,current_face_encoding in zip(all_face_locations,all_face_encodings):
        ...
        if True in all_matches:
            ...
            # Mark attendance
            if name_of_person not in attendance['Name'].values:
                attendance.loc[len(attendance)] = [name_of_person, datetime.now(), 'P']
